  ...
  return (
    <>
      ...
      <div className="container justify-between content-center bg-white flex max-w-full p-5 gap-10 my-16 flex-wrap">
        <div
          className={`${Colorc ? "bg-orange-400" : "bg-white"}
      w-96 p-5 space-x-4 border`}
          onClick={eventHanz}
        >
          <img className="logo_react w-96" src={user.imageUrl} />
          <h1 className="text-black pt-5">{user.desc}</h1>
        </div>
